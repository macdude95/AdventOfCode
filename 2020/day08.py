...
for i in range(len(master_instructions)):
	...
	instructions[i] = ins
	instructionsRun = []
	result = execute(0,0,instructions)
	if "exit" in result:
		break
print(result)
